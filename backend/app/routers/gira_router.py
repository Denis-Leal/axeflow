...
ALTERAÇÃO:
  - PUT /{gira_id}: response_model alterado de GiraResponse para GiraUpdateResponse.
      GiraUpdateResponse inclui o campo `promovidos_fila` com a lista de
      consulentes promovidos da fila de espera quando vagas aumentam.
      Sem essa mudança, o FastAPI descartava silenciosamente esse campo
      ao serializar a resposta com o schema anterior.
"""
...
def update_gira(
    ...
    """
    Atualiza dados da gira.

    Quando limite_consulentes aumenta, promove automaticamente as pessoas
    da lista de espera e retorna `promovidos_fila` para o frontend
