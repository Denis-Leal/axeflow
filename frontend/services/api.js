...
export const deleteAjeum = (giraId, ajeumId) => api.delete(`/giras/${giraId}/ajeum/${ajeumId}`); // Deleta o Ajeum da gira (e todos os itens e seleções associados)
export const deleteAjeumItem = (itemId) => api.delete(`/ajeum/itens/${itemId}`); // Deleta um item específico no Ajeum
export const deleteSelecaoAjeum = (selecaoId) => api.delete(`/ajeum/selecoes/${selecaoId}`); // Deleta uma seleção específica no Ajeum
...
export const getPerfilMembro = (id) => api.get(`/membros/${id}/perfil`);
